...
const NewWomen = () => {
  ...
  // Filter new arrival women's items
  const filteredProducts = products.filter(prod => prod.category === 'women' && prod.is_new);
  ...
  return (
    <Layout>
      <section className='main-women'>
        <div className="container">
          <div className="row">
            <div className='col-12 text-center nine'>
              <h2>New Arrival <span>Women's Items</span></h2>
            </div>
          </div>
          <div className="row">
